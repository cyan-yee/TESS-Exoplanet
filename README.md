...
- [TESS data aperture tutorial]([https://spacetelescope.github.io/mast_no](https://heasarc.gsfc.nasa.gov/docs/tess/LightCurve-object-Tutorial.html)tebooks/notebooks/TESS/beginner_how_to_use_dvt/beginner_how_to_use_dvt.html]).(https://heasarc.gsfc.nasa.gov/docs/tess/Aperture-Photometry-Tutorial.html)
